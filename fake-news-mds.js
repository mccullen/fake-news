...
function plot(table) {
    ...
    var forces = d3.forceSimulation(graph.vertices)
        .force("spring", d3.forceLink(graph.edges).distance(edge => 10*edge.distance)
    ...
    function ticked() {
        // Use D3 here to create/modify DOM objects based on the graph data...
